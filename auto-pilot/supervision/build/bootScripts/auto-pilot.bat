...
set JARPATH=%APP_HOME%\lib\auto-pilot-0.0.1-SNAPSHOT.jar

@rem Execute auto-pilot
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %AUTO_PILOT_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%AUTO_PILOT_EXIT_CONSOLE%" exit 1
exit /b 1
