...
public class InitDb {
    ...
    void initDatabase(
        ...
        // create Line
        System.out.println("New Line Initializing ! ");
        Line line = new Line();
        line.setCode("LINE_MAIN");
        line.setName(wf.ligneIndustrielle.nom());
        line.setNominalCycleS(wf.ligneIndustrielle.cycleNominalS());
        lineRepo.save(line);
